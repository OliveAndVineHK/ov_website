            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-5 md:px-6 lg:px-8">
              <div className="flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-12">
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  ) : isCorporateServiceAnnualReturn ? (
                    <div className="w-full relative h-[200px] sm:h-[250px] md:h-[280px] lg:h-[300px] mb-4 sm:mb-5 md:mb-6">
                      <Image src="/insights/annual-return-cr-bg.jpg" alt={language === "KOR" ? translations.aiTaskAutomation.ko : translations.aiTaskAutomation.en} fill className="object-cover" />
                    </div>
                  ...
                  {isCorporateServiceAnnualReturn && "section1Title" in translations && (
                    <>
                      {/* Section 1 — What Is the Annual Return (NAR1)? */}
                      <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section1Title: { en: string; ko: string } }).section1Title.ko : (translations as { section1Title: { en: string; ko: string } }).section1Title.en}</h3>

                      {/* Section 2 — Who Must File and When */}
                      {"section2Title" in translations && <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section2Title: { en: string; ko: string } }).section2Title.ko : (translations as { section2Title: { en: string; ko: string } }).section2Title.en}</h3>}
                      {"section2WhoMustFileTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section2WhoMustFileTitle: { en: string; ko: string } }).section2WhoMustFileTitle.ko : (translations as { section2WhoMustFileTitle: { en: string; ko: string } }).section2WhoMustFileTitle.en}</h4>}
                      {"section2WhoMustFileDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section2WhoMustFileDescription: { en: string; ko: string } }).section2WhoMustFileDescription.ko : (translations as { section2WhoMustFileDescription: { en: string; ko: string } }).section2WhoMustFileDescription.en}</p>}
                      {"section2PrivateDeadlineTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section2PrivateDeadlineTitle: { en: string; ko: string } }).section2PrivateDeadlineTitle.ko : (translations as { section2PrivateDeadlineTitle: { en: string; ko: string } }).section2PrivateDeadlineTitle.en}</h4>}
                      {"section2PrivateDeadlineDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section2PrivateDeadlineDescription: { en: string; ko: string } }).section2PrivateDeadlineDescription.ko : (translations as { section2PrivateDeadlineDescription: { en: string; ko: string } }).section2PrivateDeadlineDescription.en}</p>}
                      {"section2CalculationTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section2CalculationTitle: { en: string; ko: string } }).section2CalculationTitle.ko : (translations as { section2CalculationTitle: { en: string; ko: string } }).section2CalculationTitle.en}</h4>}
                      {"section2CalculationDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section2CalculationDescription: { en: string; ko: string } }).section2CalculationDescription.ko : (translations as { section2CalculationDescription: { en: string; ko: string } }).section2CalculationDescription.en}</p>}
                      {"section2PublicTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section2PublicTitle: { en: string; ko: string } }).section2PublicTitle.ko : (translations as { section2PublicTitle: { en: string; ko: string } }).section2PublicTitle.en}</h4>}
                      {"section2PublicDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section2PublicDescription: { en: string; ko: string } }).section2PublicDescription.ko : (translations as { section2PublicDescription: { en: string; ko: string } }).section2PublicDescription.en}</p>}
                      {"section2GuaranteeTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section2GuaranteeTitle: { en: string; ko: string } }).section2GuaranteeTitle.ko : (translations as { section2GuaranteeTitle: { en: string; ko: string } }).section2GuaranteeTitle.en}</h4>}
                      {"section2GuaranteeDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section2GuaranteeDescription: { en: string; ko: string } }).section2GuaranteeDescription.ko : (translations as { section2GuaranteeDescription: { en: string; ko: string } }).section2GuaranteeDescription.en}</p>}

                      {/* Section 3 — What Information Goes on the NAR1 */}
                      {"section3Title" in translations && <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section3Title: { en: string; ko: string } }).section3Title.ko : (translations as { section3Title: { en: string; ko: string } }).section3Title.en}</h3>}
                      {"section3IntroDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify mb-3">{language === "KOR" ? (translations as { section3IntroDescription: { en: string; ko: string } }).section3IntroDescription.ko : (translations as { section3IntroDescription: { en: string; ko: string } }).section3IntroDescription.en}</p>}
                      {"section3Items" in translations && Array.isArray((translations as { section3Items?: { en: string; ko: string }[] }).section3Items) && (
                        <div className="pl-8 sm:pl-10 md:pl-12 space-y-2 mb-4">
                          {((translations as { section3Items: { en: string; ko: string }[] }).section3Items).map((item, i) => (
                            <p key={i} className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed"><span className="inline-block mr-2">•</span>{language === "KOR" ? item.ko : item.en}</p>
                      ...
                      {/* Section 4 — How to File the Annual Return */}
                      {"section4Title" in translations && <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section4Title: { en: string; ko: string } }).section4Title.ko : (translations as { section4Title: { en: string; ko: string } }).section4Title.en}</h3>}
                      {"section4IntroDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify mb-3">{language === "KOR" ? (translations as { section4IntroDescription: { en: string; ko: string } }).section4IntroDescription.ko : (translations as { section4IntroDescription: { en: string; ko: string } }).section4IntroDescription.en}</p>}
                      {"section4EfilingTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section4EfilingTitle: { en: string; ko: string } }).section4EfilingTitle.ko : (translations as { section4EfilingTitle: { en: string; ko: string } }).section4EfilingTitle.en}</h4>}
                      {"section4EfilingDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section4EfilingDescription: { en: string; ko: string } }).section4EfilingDescription.ko : (translations as { section4EfilingDescription: { en: string; ko: string } }).section4EfilingDescription.en}</p>}
                      {"section4InPersonTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section4InPersonTitle: { en: string; ko: string } }).section4InPersonTitle.ko : (translations as { section4InPersonTitle: { en: string; ko: string } }).section4InPersonTitle.en}</h4>}
                      {"section4InPersonDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section4InPersonDescription: { en: string; ko: string } }).section4InPersonDescription.ko : (translations as { section4InPersonDescription: { en: string; ko: string } }).section4InPersonDescription.en}</p>}
                      {"section4PostTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section4PostTitle: { en: string; ko: string } }).section4PostTitle.ko : (translations as { section4PostTitle: { en: string; ko: string } }).section4PostTitle.en}</h4>}
                      {"section4PostDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section4PostDescription: { en: string; ko: string } }).section4PostDescription.ko : (translations as { section4PostDescription: { en: string; ko: string } }).section4PostDescription.en}</p>}
                      {"section4DropboxTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section4DropboxTitle: { en: string; ko: string } }).section4DropboxTitle.ko : (translations as { section4DropboxTitle: { en: string; ko: string } }).section4DropboxTitle.en}</h4>}
                      {"section4DropboxDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section4DropboxDescription: { en: string; ko: string } }).section4DropboxDescription.ko : (translations as { section4DropboxDescription: { en: string; ko: string } }).section4DropboxDescription.en}</p>}
                      {"section4FeesTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section4FeesTitle: { en: string; ko: string } }).section4FeesTitle.ko : (translations as { section4FeesTitle: { en: string; ko: string } }).section4FeesTitle.en}</h4>}
                      {"section4FeesDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section4FeesDescription: { en: string; ko: string } }).section4FeesDescription.ko : (translations as { section4FeesDescription: { en: string; ko: string } }).section4FeesDescription.en}</p>}

                      {/* Section 5 — Penalties and Consequences */}
                      {"section5Title" in translations && <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section5Title: { en: string; ko: string } }).section5Title.ko : (translations as { section5Title: { en: string; ko: string } }).section5Title.en}</h3>}
                      {"section5IntroDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify mb-3">{language === "KOR" ? (translations as { section5IntroDescription: { en: string; ko: string } }).section5IntroDescription.ko : (translations as { section5IntroDescription: { en: string; ko: string } }).section5IntroDescription.en}</p>}
                      {"section5LateFeesTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section5LateFeesTitle: { en: string; ko: string } }).section5LateFeesTitle.ko : (translations as { section5LateFeesTitle: { en: string; ko: string } }).section5LateFeesTitle.en}</h4>}
                      {"section5LateFeesTableRows" in translations && Array.isArray((translations as { section5LateFeesTableRows?: { timing: { en: string; ko: string }; fee: string }[] }).section5LateFeesTableRows) && (
                        <div className="pl-8 sm:pl-10 md:pl-12 mb-4 overflow-x-auto">
                          <table className="w-full text-sm sm:text-base border-collapse">
                            <thead>
                              <tr className="border-b border-gray-300">
                                <th className="text-left py-2 pr-4 font-semibold text-[#333333]">{language === "KOR" ? "기간" : "Timing"}</th>
                                <th className="text-left py-2 font-semibold text-[#333333]">{language === "KOR" ? "수수료" : "Fee"}</th>
                              </tr>
                            </thead>
                            <tbody>
                              {((translations as { section5LateFeesTableRows: { timing: { en: string; ko: string }; fee: string }[] }).section5LateFeesTableRows).map((row, i) => (
                                <tr key={i} className="border-b border-gray-200">
                                  <td className="py-2 pr-4 text-[#111B12]">{language === "KOR" ? row.timing.ko : row.timing.en}</td>
                                  <td className="py-2 text-[#111B12] font-medium">{row.fee}</td>
                                </tr>
                              ))}
                            </tbody>
                          </table>
                      ...
                      {"section5ProsecutionTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section5ProsecutionTitle: { en: string; ko: string } }).section5ProsecutionTitle.ko : (translations as { section5ProsecutionTitle: { en: string; ko: string } }).section5ProsecutionTitle.en}</h4>}
                      {"section5ProsecutionDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section5ProsecutionDescription: { en: string; ko: string } }).section5ProsecutionDescription.ko : (translations as { section5ProsecutionDescription: { en: string; ko: string } }).section5ProsecutionDescription.en}</p>}
                      {"section5StrikeOffTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section5StrikeOffTitle: { en: string; ko: string } }).section5StrikeOffTitle.ko : (translations as { section5StrikeOffTitle: { en: string; ko: string } }).section5StrikeOffTitle.en}</h4>}
                      {"section5StrikeOffDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section5StrikeOffDescription: { en: string; ko: string } }).section5StrikeOffDescription.ko : (translations as { section5StrikeOffDescription: { en: string; ko: string } }).section5StrikeOffDescription.en}</p>}
                      {"section5GoodStandingTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section5GoodStandingTitle: { en: string; ko: string } }).section5GoodStandingTitle.ko : (translations as { section5GoodStandingTitle: { en: string; ko: string } }).section5GoodStandingTitle.en}</h4>}
                  ...
                  {isTaxPropertyTaxHongKong && "section1Title" in translations && (
                    <>
                      {/* Section 1 — What Is Property Tax? */}
                      <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section1Title: { en: string; ko: string } }).section1Title.ko : (translations as { section1Title: { en: string; ko: string } }).section1Title.en}</h3>

                      {/* Section 2 — How Property Tax Is Calculated */}
                      {"section2Title" in translations && <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section2Title: { en: string; ko: string } }).section2Title.ko : (translations as { section2Title: { en: string; ko: string } }).section2Title.en}</h3>}
                      {"section2AssessableValueTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section2AssessableValueTitle: { en: string; ko: string } }).section2AssessableValueTitle.ko : (translations as { section2AssessableValueTitle: { en: string; ko: string } }).section2AssessableValueTitle.en}</h4>}
                      {"section2AssessableValueDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section2AssessableValueDescription: { en: string; ko: string } }).section2AssessableValueDescription.ko : (translations as { section2AssessableValueDescription: { en: string; ko: string } }).section2AssessableValueDescription.en}</p>}
                      {"section2DeductionsTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section2DeductionsTitle: { en: string; ko: string } }).section2DeductionsTitle.ko : (translations as { section2DeductionsTitle: { en: string; ko: string } }).section2DeductionsTitle.en}</h4>}
                      {"section2DeductionsDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section2DeductionsDescription: { en: string; ko: string } }).section2DeductionsDescription.ko : (translations as { section2DeductionsDescription: { en: string; ko: string } }).section2DeductionsDescription.en}</p>}
                      {"section2RateTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section2RateTitle: { en: string; ko: string } }).section2RateTitle.ko : (translations as { section2RateTitle: { en: string; ko: string } }).section2RateTitle.en}</h4>}
                      {"section2RateDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section2RateDescription: { en: string; ko: string } }).section2RateDescription.ko : (translations as { section2RateDescription: { en: string; ko: string } }).section2RateDescription.en}</p>}
                      {"section2ExampleTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section2ExampleTitle: { en: string; ko: string } }).section2ExampleTitle.ko : (translations as { section2ExampleTitle: { en: string; ko: string } }).section2ExampleTitle.en}</h4>}
                      {"section2ExampleIntro" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-3">{language === "KOR" ? (translations as { section2ExampleIntro: { en: string; ko: string } }).section2ExampleIntro.ko : (translations as { section2ExampleIntro: { en: string; ko: string } }).section2ExampleIntro.en}</p>}
                      {"section2ExampleTableRows" in translations && Array.isArray((translations as { section2ExampleTableRows?: { item: { en: string; ko: string }; amount: string }[] }).section2ExampleTableRows) && (
                        <div className="pl-8 sm:pl-10 md:pl-12 mb-5 sm:mb-6 overflow-x-auto">
                          <table className="w-full text-sm sm:text-base border-collapse">
                            <thead>
                              <tr className="border-b border-gray-300">
                                <th className="text-left py-2 pr-4 font-semibold text-[#333333]">{language === "KOR" ? "항목" : "Item"}</th>
                                <th className="text-right py-2 font-semibold text-[#333333]">{language === "KOR" ? "금액" : "Amount"}</th>
                              </tr>
                            </thead>
                            <tbody>
                              {((translations as { section2ExampleTableRows: { item: { en: string; ko: string }; amount: string }[] }).section2ExampleTableRows).map((row, i) => (
                                <tr key={i} className="border-b border-gray-200">
                                  <td className="py-2 pr-4 text-[#111B12]">{language === "KOR" ? row.item.ko : row.item.en}</td>
                                  <td className="py-2 text-right text-[#111B12] font-medium">{row.amount}</td>
                                </tr>
                              ))}
                            </tbody>
                          </table>
                      ...
                      {/* Section 3 — What Counts as Rental Income */}
                      {"section3Title" in translations && <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section3Title: { en: string; ko: string } }).section3Title.ko : (translations as { section3Title: { en: string; ko: string } }).section3Title.en}</h3>}
                      {"section3IntroDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify mb-3">{language === "KOR" ? (translations as { section3IntroDescription: { en: string; ko: string } }).section3IntroDescription.ko : (translations as { section3IntroDescription: { en: string; ko: string } }).section3IntroDescription.en}</p>}
                      {"section3Items" in translations && Array.isArray((translations as { section3Items?: { en: string; ko: string }[] }).section3Items) && (
                        <div className="pl-8 sm:pl-10 md:pl-12 space-y-2 mb-4">
                      ...
                      {"section3NotDeductibleTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section3NotDeductibleTitle: { en: string; ko: string } }).section3NotDeductibleTitle.ko : (translations as { section3NotDeductibleTitle: { en: string; ko: string } }).section3NotDeductibleTitle.en}</h4>}
                      {"section3NotDeductibleDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section3NotDeductibleDescription: { en: string; ko: string } }).section3NotDeductibleDescription.ko : (translations as { section3NotDeductibleDescription: { en: string; ko: string } }).section3NotDeductibleDescription.en}</p>}

                      {/* Section 4 — Who Pays and How to Report */}
                      {"section4Title" in translations && <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section4Title: { en: string; ko: string } }).section4Title.ko : (translations as { section4Title: { en: string; ko: string } }).section4Title.en}</h3>}
                      {"section4SoleTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section4SoleTitle: { en: string; ko: string } }).section4SoleTitle.ko : (translations as { section4SoleTitle: { en: string; ko: string } }).section4SoleTitle.en}</h4>}
                      {"section4SoleDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section4SoleDescription: { en: string; ko: string } }).section4SoleDescription.ko : (translations as { section4SoleDescription: { en: string; ko: string } }).section4SoleDescription.en}</p>}
                      {"section4JointTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section4JointTitle: { en: string; ko: string } }).section4JointTitle.ko : (translations as { section4JointTitle: { en: string; ko: string } }).section4JointTitle.en}</h4>}
                      {"section4JointDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section4JointDescription: { en: string; ko: string } }).section4JointDescription.ko : (translations as { section4JointDescription: { en: string; ko: string } }).section4JointDescription.en}</p>}
                      {"section4CorporateTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section4CorporateTitle: { en: string; ko: string } }).section4CorporateTitle.ko : (translations as { section4CorporateTitle: { en: string; ko: string } }).section4CorporateTitle.en}</h4>}
                      {"section4CorporateDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section4CorporateDescription: { en: string; ko: string } }).section4CorporateDescription.ko : (translations as { section4CorporateDescription: { en: string; ko: string } }).section4CorporateDescription.en}</p>}
                      {"section4NotifyTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section4NotifyTitle: { en: string; ko: string } }).section4NotifyTitle.ko : (translations as { section4NotifyTitle: { en: string; ko: string } }).section4NotifyTitle.en}</h4>}
                      {"section4NotifyDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section4NotifyDescription: { en: string; ko: string } }).section4NotifyDescription.ko : (translations as { section4NotifyDescription: { en: string; ko: string } }).section4NotifyDescription.en}</p>}
                      {"section4ProvisionalTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section4ProvisionalTitle: { en: string; ko: string } }).section4ProvisionalTitle.ko : (translations as { section4ProvisionalTitle: { en: string; ko: string } }).section4ProvisionalTitle.en}</h4>}
                      {"section4ProvisionalDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section4ProvisionalDescription: { en: string; ko: string } }).section4ProvisionalDescription.ko : (translations as { section4ProvisionalDescription: { en: string; ko: string } }).section4ProvisionalDescription.en}</p>}

                      {/* Section 5 — Property Tax, Profits Tax, and Personal Assessment */}
                      {"section5Title" in translations && <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section5Title: { en: string; ko: string } }).section5Title.ko : (translations as { section5Title: { en: string; ko: string } }).section5Title.en}</h3>}
                      {"section5IntroDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify mb-3">{language === "KOR" ? (translations as { section5IntroDescription: { en: string; ko: string } }).section5IntroDescription.ko : (translations as { section5IntroDescription: { en: string; ko: string } }).section5IntroDescription.en}</p>}
                      {"section5SetOffTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section5SetOffTitle: { en: string; ko: string } }).section5SetOffTitle.ko : (translations as { section5SetOffTitle: { en: string; ko: string } }).section5SetOffTitle.en}</h4>}
                      {"section5SetOffDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section5SetOffDescription: { en: string; ko: string } }).section5SetOffDescription.ko : (translations as { section5SetOffDescription: { en: string; ko: string } }).section5SetOffDescription.en}</p>}
                      {"section5PersonalAssessmentTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section5PersonalAssessmentTitle: { en: string; ko: string } }).section5PersonalAssessmentTitle.ko : (translations as { section5PersonalAssessmentTitle: { en: string; ko: string } }).section5PersonalAssessmentTitle.en}</h4>}
                      {"section5PersonalAssessmentDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section5PersonalAssessmentDescription: { en: string; ko: string } }).section5PersonalAssessmentDescription.ko : (translations as { section5PersonalAssessmentDescription: { en: string; ko: string } }).section5PersonalAssessmentDescription.en}</p>}
                      {"section5MortgageTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section5MortgageTitle: { en: string; ko: string } }).section5MortgageTitle.ko : (translations as { section5MortgageTitle: { en: string; ko: string } }).section5MortgageTitle.en}</h4>}
                      {"section5MortgageDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section5MortgageDescription: { en: string; ko: string } }).section5MortgageDescription.ko : (translations as { section5MortgageDescription: { en: string; ko: string } }).section5MortgageDescription.en}</p>}
                      {"section5RestorationNote" in translations && (
                        <div className="border-l-4 border-[#627F38] pl-4 py-2 mb-5 sm:mb-6">
