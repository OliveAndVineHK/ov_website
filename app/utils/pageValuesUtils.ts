export const valuesPageTranslations = {
  pageTitle: { en: "Our Values", ko: "Our Values" },

  // Mission
  missionLabel: { en: "Our Mission", ko: "Our Mission" },
  missionStatement: {
    en: "To transform advisory from transactional to transformational—building partnerships that enable our clients to dream bigger, decide bolder, and deliver greater impact.",
    ko: "단기적 업무 중심의 자문을 넘어, 변화를 이끄는 자문을 통해 고객이 더 크게 꿈꾸고, 더 확신 있게 결정하며, 더 큰 가치를 만들어낼 수 있도록 함께하는 파트너십을 구축합니다.",
  },
  ...
  values: [
    {
      number: "1",
      title: { en: "Integrity", ko: "정직성 Integrity" },
      statement: {
        en: "We don't compromise on honesty, even when it's inconvenient.",
        ko: "어떠한 상황에서도 정직함을 타협하지 않습니다. ",
      },
      body: {
        ...
        ko: "정직함은 듣기 좋은 말이 아니라, 반드시 필요한 이야기를 전하는 것에서 시작합니다. 리스크가 발견되면, 숨기지 않고 명확하고 협력적인 방식으로 공유합니다. 약속은 반드시 지켜져야 할 원칙입니다. 고객이 우리를 신뢰하는 이유는 단기적인 편의가 아닌 장기적인 이익을 우선한다는 점에 있습니다. 우리는 진실을 바탕으로 관계를 구축하고, 흔들림 없는 정직함으로 그 관계를 지켜갑니다.",
      },
    },
    {
      number: "2",
      title: { en: "Excellence", ko: "탁월성 Excellence" },
      statement: {
        en: "Excellence is not a destination—it's our daily practice.",
        ko: "탁월함은 목표가 아니라, 지속적으로 실천하는 기준입니다.",
      },
      body: {
    ...
    {
      number: "3",
      title: { en: "Partnership", ko: "파트너십 Partnership" },
      statement: {
        en: "Your growth is our growth. We win when you win.",
        ko: "고객이 성장할 때, 우리도 함께 성장합니다.",
      },
      body: {
        ...
        ko: "우리는 단순히 업무를 수행하는 외부인력이 아니라, 고객의 미래에 함께 투자하는 조력자입니다. 매 순간 고객의 의사결정을 함께 고민하고, 예상되는 과제를 사전에 발굴하여 선제적으로 대비 합니다. 중요한 선택의 기로에서는 파트너로서 기꺼이 의견을 나누고, 변화의 모든 과정 끝까지 함께  합니다. 진정한 파트너십은 높은 수준의 투명성을 요구하기에, 우리의 모든 자문 내용은 고객이 명확히 이해할 수 있도록 투명하게 공개되며 보수 체계 역시 분명하고 합리적으로 제시됩니다. 우리의 가치는 투입된 업무 시간이 아닌, 고객과 함께 만들어낸 실절적인 결과로 증명됩니다.",
      },
    },
    {
      number: "4",
      title: { en: "Compassion", ko: "공감 Compassion" },
      statement: {
        en: "Behind every number is a person, a dream, a story.",
        ko: "숫자 뒤에는 언제나 사람, 꿈, 이야기가 있습니다.",
      },
      body: {
        ...
        ko: "공감은 단순한 자문과 신뢰받는 자문을 구분하는 기준입니다. 우리는 고객의 상황을 이해하는 데 충분한 시간을 투자합니다 —\n당면한 압박, 이루고자 하는 목표, 그리고 그 방향까지 함께 이해합니다. 형식적인 청취가 아니라, 진심으로 귀 기울입니다. 어려운 상황에 직면했을 때는 전략에 앞서 공감하고, 성과를 이루었을 때는 그 기쁨을 함께 나눕니다. 공감은 단순한 태도가 아니라, 고객을 진심으로 돕고자 하는 책임감의 발현입니다. 이러한 진정성은 비즈니스 관계를 넘어, 깊은 신뢰를 바탕으로 한 지속 가능한 파트너십을 완성 합니다.",
      },
    },
    {
      number: "5",
      title: { en: "Growth", ko: "성장 Growth" },
      statement: {
        en: "We believe in the power of continuous evolution.",
        ko: "우리는 지속적인 발전의 힘을 믿습니다.",
      },
      body: {
        ...
        ko: "성장은 단순한 매출의 증가가 아니라, 개인과 조직이 더 나은 모습으로 변화해 가는 과정입니다. 우리는 팀의 성장이 곧 조직의 성과로 이어진다고 믿으며, 이를 위해 지속적으로 투자하고 발전을 지원합니다. \n\n또한 변화와 혁신을 적극적으로 받아들여 산업의 흐름과 규제 환경의 변화에 항상 앞서 대응합니다. 높은 전문성과 기준을 유지하면서도, 새로운 사고와 접근을 지속적으로 추구합니다. \n\n이러한 성장은 매일 더 나은 방식으로 고객을 지원하기 위해 스스로에게 끊임없이 질문하는것으로부터 시작됩니다. 우리는 모든 업무로부터 학습하며, 성과와 실패 모두를 발전의 기반으로 활용합니다. 이러한 접근은 고객에게 지속적으로 가치를 제공하는 기반이 됩니다.",
      },
    },
  ],

  // Promise
  promiseLabel: { en: "Our Promise", ko: "Our Promise" },
  promiseTitle: {
    en: "You are Not Alone in This",
    ko: "언제나 함께합니다",
  },
  promiseBody: {
    ...
    ko: "Olive & Vine과 함께한다는 것은, 단순한 자문을 넘어서 함께 고민하고 함께 성장하는 팀을 곁에 두는 것입니다. \n\n우리는 고객의 목표를 이해하고, 예상되는 과제를 함께 준비하며, 모든 변화의 과정에 함께하는 팀입니다. 우리는 고객의 목표를 깊이 이해하고, 앞으로 마주할 도전과 변화의 과정을 언제나 함께 준비합니다. 우리는 단순한 자문 제공자에 머무르지 않습니다. 고객의 입장에서 함께 고민하는 조력자이며, 함께 성장하는 파트너이자, 언제든 믿고 의지할 수 있는 팀입니다.",
  },

  ctaButton: { en: "Let's Connect", ko: "문의하기" },
};
