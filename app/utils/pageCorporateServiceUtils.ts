export const corporateServicePageTranslations = {
  ...
  heroSubtitle: {
    en: "Hong Kong's Companies Ordinance imposes ongoing statutory obligations on companies throughout their lifecycle—from incorporation and day‑to‑day operations to eventual winding‑down.\nWe manage the procedural and compliance requirements, allowing you to focus on running and growing your business.",
    ko: "홍콩 회사조례(Companies Ordinance)에 따라, 기업은 설립부터 운영, 청산에 이르기까지 전 과정에 걸쳐 지속적인 규제 준수 의무가 요구됩니다.\n이러한 절차와 규제 업무를 체계적으로 관리하여, 고객이 본업에 집중할 수 있도록 지원합니다.",
  },
  title: {
    en: "Corporate Service",
    ko: "기업 서비스",
  },
  startUp: { en: "Start", ko: "설립 및 초기" },
  startUpDescription: {
    ...
    ko: "디지털 기반의 온보딩 프로세스를 통해 법인 설립, 사업자 등록 및 계좌 개설을 효율적으로 진행합니다.\n표준화된 양식과 전자 문서, 자동화된 프로세스를 적용하여, 신규 기업이 초기 단계부터 규제 준수를 충족할 수 있도록 지원합니다.",
  },
  startUpItems: {
  ...
  inBusinessItems: {
    en: [
      ...
      "Annual General Meetings and Board of Meetings",
      "Provision of registered office",
      "Internal policies and procedures review and advisory",
      "HR service",
  ...
  digitalisationDescription: {
    ...
    ko: "클라우드 기반 시스템과 자동화된 알림을 활용하여, 연차보고, 이사 변경 및 법정 정보 관리를 포함한 기업관리 업무를 디지털 방식으로 수행합니다. 이를 통해 업데이트를 효율적으로 관리합니다. 아울러 필요에 따라 전자서명 도구를 통해 종이 기반 업무를 최소화하고 처리 효율성을 높이며, 모든 문서와 신고 내역은 명확하게 추적 및 관리됩니다. 구조화된 시스템 기반 프레임워크를 통해 기업 기록의 전 과정 추적과 실시간 규제 준수를 가능하게 하여, 기업 관리 업무를 부담이 아닌 신뢰할 수 있는 일상적 프로세스로 전환합니다.",
  },
